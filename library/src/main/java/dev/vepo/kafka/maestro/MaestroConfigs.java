...
public class MaestroConfigs extends AbstractConfig {
    ...
    public static final Duration DEFAULT_MAESTRO_ADAPTER_TICK_FREQUENCY = Duration.ofMinutes(2);
    ...
    public static final int DEFAULT_MAESTRO_ADAPTER_HISTORY_SIZE_MIN = (int) Duration.ofMinutes(15).dividedBy(DEFAULT_METRICS_COLLECTION_FREQUENCY) - 1;
