...
4. Inject Data
   ```bash
   mvn -pl experiment/data-generator/ clean compile exec:java -Dexec.mainClass=io.vepo.kafka.stream.datagenerator.InjectData -Dexec.args="-d ./train-data -t 20 -r 1000 train"
   ```
